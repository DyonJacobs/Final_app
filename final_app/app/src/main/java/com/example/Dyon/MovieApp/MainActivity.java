package com.example.Dyon.MovieApp;
...
import com.example.Dyon.MovieApp.Database.AppDatabase;
import com.example.Dyon.MovieApp.R;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void openFavo(){
        ...
        Toast.makeText(this, "Switching to favorites", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_start:
                ...
                startActivity(naarMovieList);
                Toast.makeText(this, "Switching to movie list", Toast.LENGTH_SHORT).show();
        }
    }
